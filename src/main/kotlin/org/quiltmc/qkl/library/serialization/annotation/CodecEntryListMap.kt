...
/**
 * If the target property is a map or otherwise serialized as a [map structure][StructureKind.MAP],
 * marks it to be serialized as a list of key-value pairs instead.
 *
